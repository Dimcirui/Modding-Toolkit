...
TRANSLATIONS = {
    "en_US": {
        ...
        ("*", "一键添加表情骨"): "One-Click Add Facial Bones",
        ("*", "使用该功能将清除原本存在的表情骨！"): "This will clear any existing facial bones!",
        ("*", "增加眨眼幅度（二次元模型用）"): "Increase blink amplitude (for anime-style models)",
